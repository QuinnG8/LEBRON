document.querySelectorAll('.edit-button').forEach(cell => cell.addEventListener('click', function (e) { 
  ...
  document.getElementById('delete-form').classList.remove('visible');
}));

document.querySelectorAll('.delete-button').forEach(cell => cell.addEventListener('click', function (e) { 
  e.preventDefault();
  document.getElementById('edit-form').classList.remove('visible');
  document.getElementById('add-form').classList.remove('visible');
  document.getElementById('delete-form').classList.add('visible');
}));
